...
fn collect_early_exit<'s, I: 's, R, F, E, It>(it: It, func: F) -> Result<Vec<R>, E>
where
...
// TODO: make a frozen inner class that isn't coupled to GIL. Have outer class that manages it through an Arc smart pointer?
#[pyclass]
struct DataFrame {
